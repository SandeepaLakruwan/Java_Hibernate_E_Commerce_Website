...
public class Checkout extends HttpServlet {
        ...
        if (httpSession.getAttribute("user") != null) {
            ...
            if (isCurrentAddress) {
                ...
                if (criteria2.list().isEmpty()) {
                    ...
                    saveOrder(session, transaction, user, address, responseJsonObject, user_DTO.getEmail());
                }
            } else {
                //create new address
    ...
    private void saveOrder(Session session, Transaction transaction, User user, Address address, JsonObject responseJsonObject, String email) {
        try {
            //Create Oder in db
            ...
            String invoiceHtml = InvoiceGenerator.generateInvoiceHtml(
                    order.getUser().getFname() + " " + order.getUser().getLname(),
                    order.getAddress().getLine1() + ", " + order.getAddress().getLine2() + ", " + order.getAddress().getCity().getName(),
            ...
            Mail.sendMail(email, "Your Purchase Summary", invoiceHtml);
            ...
            String merchnt_id = "merchant-id-here";
            String formatedAmount = new DecimalFormat("0.00").format(amount);
            String currency = "LKR";
            String merchantSecret = "merchant-secret-here";
            ...
            payhere.addProperty("return_url", "index.html");
