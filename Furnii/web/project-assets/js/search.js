...
function updateProductView(json) {
    ...
    json.productList.forEach(product => {
        ...
        st_product_clone.querySelector("#search-addToCart").addEventListener(
                    "click",
                    (e) => {
    ...
    if (currentPage != 0) {
        ...
        st_pagination_button_clone_prev.style.backgroundColor = "#92bd4d";
        st_pagination_button_clone_prev.style.color = "#1a1714";
    ...
    for (let i = 0; i < pages; i++) {
        ...
        if (i == currentPage) {
            st_pagination_button_clone.className = "axil-btn ml--10";
            st_pagination_button_clone.style.backgroundColor = "#c9915f";
            st_pagination_button_clone.style.color = "#1a1714";
        } else {
            st_pagination_button_clone.className = "axil-btn ml--10";
            st_pagination_button_clone.style.backgroundColor = "#f7d1b0";
            st_pagination_button_clone.style.color = "#1a1714";
        }
    ...
    if (currentPage != (pages - 1)) {
        ...
        st_pagination_button_clone_next.style.backgroundColor = "#92bd4d";
        st_pagination_button_clone_next.style.color = "#1a1714";
